...
fun yyAction51 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN STRING; str_switch := 1; str := ""; continue()))
...
fun yyAction58 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (YYBEGIN INITIAL; str_switch := 0; Tokens.STRING(!str, yypos, yypos + String.size yytext))
      end
       ...
       of NONE => yyAction45(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction45(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ60(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
              else yyAction45(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction45(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction45(strm, yyNO_MATCH)
                  else yyQ98(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ60(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
              else yyAction45(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction45(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction45(strm, yyNO_MATCH)
                  else yyQ102(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ60(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
              else yyAction45(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ40 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction25(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ104(strm', yyMATCH(strm, yyAction25, yyNO_MATCH))
       ...
       of NONE => yyAction27(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              ...
              then if inp = #"="
                  then yyQ105(strm', yyMATCH(strm, yyAction27, yyNO_MATCH))
