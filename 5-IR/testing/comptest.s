...
comptest:     file format elf64-x86-64
...
0000000000000368 <.note.gnu.build-id>:
 ...
 377:	00 98 9f d9 ac aa    	add    %bl,-0x55532661(%rax)
 37d:	07                   	(bad)  
 37e:	b4 db                	mov    $0xdb,%ah
 380:	7b 0a                	jnp    38c <__abi_tag>
 382:	1c 98                	sbb    $0x98,%al
 384:	c5 8c 53             	(bad)
 387:	83 5d 37 62          	sbbl   $0x62,0x37(%rbp)
 38b:	4b                   	rex.WXB
...
0000000000000480 <.dynstr>:
 ...
 49e:	61                   	(bad)  
 49f:	69 6e 00 70 72 69 6e 	imul   $0x6e697270,0x0(%rsi),%ebp
 ...
 4e4:	65 00 5f 5f          	add    %bl,%gs:0x5f(%rdi)
...
0000000000001149 <main>:
    ...
    115c:	c7 45 f8 06 00 00 00 	movl   $0x6,-0x8(%rbp)
    1163:	8b 45 f4             	mov    -0xc(%rbp),%eax
    1166:	3b 45 f8             	cmp    -0x8(%rbp),%eax
    ...
    1177:	48 8d 05 86 0e 00 00 	lea    0xe86(%rip),%rax        # 2004 <_IO_stdin_used+0x4>
...
0000000000003dc8 <_DYNAMIC>:
    ...
    3def:	00 94 11 00 00 00 00 	add    %dl,0x0(%rcx,%rdx,1)
