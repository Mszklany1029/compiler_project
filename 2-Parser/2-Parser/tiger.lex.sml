       ...
       of NONE => yyAction45(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ45(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction45(strm, yyNO_MATCH)
                  else yyQ41(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
       ...
       of NONE => yyAction45(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ44(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
            else if inp < #"l"
              then if inp = #"`"
                  then yyAction45(strm, yyNO_MATCH)
                  else yyQ41(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
       ...
       of NONE => yyAction45(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ43(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
            else if inp < #"i"
              then if inp = #"`"
                  then yyAction45(strm, yyNO_MATCH)
                  else yyQ41(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
       ...
       of NONE => yyAction45(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction45(strm, yyNO_MATCH)
                  else yyQ46(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ41(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
              else yyAction45(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"a"
              ...
              then if inp = #"i"
                  ...
                  then if inp = #"h"
                      then yyQ48(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
                      else yyQ41(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
                else if inp = #"o"
                  then yyQ49(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
                  else yyQ41(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
            else if inp = #"z"
              then yyQ41(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
            else if inp < #"z"
              then if inp = #"y"
                  then yyQ50(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
                  else yyQ41(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
              else yyAction45(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction17(strm, yyNO_MATCH)
                      else yyQ40(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction17(strm, yyNO_MATCH)
       ...
       of NONE => yyAction45(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction45(strm, yyNO_MATCH)
                  else yyQ79(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ41(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
              else yyAction45(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction45(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction45(strm, yyNO_MATCH)
                  else yyQ83(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ41(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
              else yyAction45(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ19 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction27(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              then yyQ87(strm', yyMATCH(strm, yyAction27, yyNO_MATCH))
            else if inp < #">"
              then if inp = #"="
                  then yyQ86(strm', yyMATCH(strm, yyAction27, yyNO_MATCH))
